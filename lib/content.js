...
export const hero = {
  headline: 'Organically Raised Beef Shares in Caledonia, NY',
...
export const faq = [
  ...
  },
  {
    ...
    a: "Our cattle are on our pasture roughly eight months of the year and eat our own hay through the winter, with certified organic grain every day alongside. So they're pasture-raised and grass-and-grain fed — not \"grass-finished.\" Here's why we do it this way. Grass-finishing in Western New York means two winters on stored feed and an animal that takes about twice as long to finish, which roughly doubles the cost per pound. Grain builds marbling, and marbling is what makes beef tender and juicy — that's the beef we want to eat and the beef we want to sell. And because our grain is certified organic, it carries none of the things people worry about with feedlot beef — no GMO corn, no confinement, no routine antibiotics. If strictly grass-finished beef is what you're after, we're not the right fit and we'd rather tell you that up front. If you want beef from cattle that lived on grass and finished with organic grain, that's us.",
  },
  {
